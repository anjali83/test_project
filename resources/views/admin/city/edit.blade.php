@extends('admin.layouts.app', ['activePage' => 'city', 'titlePage' => __('Edit City')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" id="stateFrm" action="{{ route('admin.city.update',$details->id) }}" autocomplete="off" class="form-horizontal">
            @csrf   
            @method('put')       
