@extends('admin.layouts.app', ['activePage' => 'state', 'titlePage' => __('Add New State')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" id="stateFrm" action="{{ route('admin.state.store') }}" autocomplete="off" class="form-horizontal">
            @csrf          
