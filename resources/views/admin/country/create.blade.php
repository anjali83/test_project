@extends('admin.layouts.app', ['activePage' => 'country', 'titlePage' => __('Add New Country')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" id="countryFrm" action="{{ route('admin.country.store') }}" autocomplete="off" class="form-horizontal">
            @csrf          
