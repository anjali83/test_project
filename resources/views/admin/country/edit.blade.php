@extends('admin.layouts.app', ['activePage' => 'country', 'titlePage' => __('Edit Country')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" id="countryFrm" action="{{ route('admin.country.update',$details->id) }}" autocomplete="off" class="form-horizontal">
            @csrf  
            @method('put')        
